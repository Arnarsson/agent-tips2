...
import { GradientHeading } from "./agent/gradient-heading"
import {
  TextureCard,
  TextureCardContent,
  TextureCardHeader,
} from "./agent/texture-card"
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab}>
            ...
            <TabsContent value="about" className="mt-4">
              <p className="text-foreground/90 text-base">
                Agent.tips is a local-first AI prompt manager designed to help you create, organize, and optimize your prompts offline.
              </p>
            </TabsContent>
